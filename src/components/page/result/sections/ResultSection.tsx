...
export function ResultSection({ data, metadata }: ResultSectionProps) {
  ...
  // Force default view to table as per user request
  ...
  return (
    <div className="w-full max-w-3xl pt-8 flex border-t border-gray-200 dark:border-gray-700 flex-col gap-2 mt-8">
      ...
      <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-lg p-3 flex items-start gap-3 mt-4">
        ...
        <div className="text-sm text-gray-700 dark:text-gray-300">
          {/* <p className="font-medium mb-0.5">AI-Generated Content</p> */}
          <p className="text-gray-600 dark:text-gray-400">
            AI interprets your question to get data from the database. If the
            results look off, try rephrasing your query
          </p>
        </div>
      </div>
    </div>
